...
class GenerateCodeMySelf extends StatefulWidget {
  final String appName;
  final String email;
  const GenerateCodeMySelf(
      {Key? key, required this.appName, required this.email})
      : super(key: key);

  @override
  State<GenerateCodeMySelf> createState() => _GenerateCodeMySelfState();
}

class _GenerateCodeMySelfState extends State<GenerateCodeMySelf> {
  String secKey = '';
  ...
  activate2FA(context) async {
    ...
    localStorage.setString('recoverPhrase', recoveryPhrase);
              ...
              children: [
                ...
                SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        SharedPreferences localStorage = await SharedPreferences.getInstance();
                        await localStorage.setBool('activate2FA', false);
                        Navigator.pop(context);
                      },
                      style: ButtonStyle(
