...
import 'package:readee_app/widget/recover2fa.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:pinput/pinput.dart';

class VerifyCodeMySelf extends StatefulWidget {
  final Widget successPage;
  const VerifyCodeMySelf({Key? key, required this.successPage})
      : super(key: key);

  @override
  State<VerifyCodeMySelf> createState() => _VerifyCodeMySelfState();
}

class _VerifyCodeMySelfState extends State<VerifyCodeMySelf> {
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Recover2FAPage()),
                    );
                  },
                  child: Text(
                    "recover 2fa",
                    style: TextStyle(
                      color: Colors.blue[400], // Makes the text look like a link
                    ),
                  ),
                ),
                const SizedBox(
